...
<?php echo $__env->make("_particles.mypage_slider", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
...
<!-- End Content =============================================== --> 
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div calss="row" style="padding-top:15px;">
              <img class="user-photo" src="<?php echo e(asset('assets/frontend/pages/img/hotspring/6A06AA58C7FEC2C5916B28670459D46C.jpg')); ?>">
          ...
          <div class="col-md-9">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <label class="fileEdit">(姓)
                      <input type="text" name="name" class="profile-input name" id="name" value="<?php echo e($user->first_name); ?>">
                    </label>
                  </div>
                  <div class="col-md-6">
                    <label class="fileEdit">(姓)
                      <input type="text" name="name" class="profile-input name" id="name" value="<?php echo e($user->last_name); ?>">
                    </label>
                  </div>
                </div>
              </div>
            ...
            <div class="row" style="padding-top:25px;">
              ...
              <div class="col-md-9">
                <input type="text" name="address" class="profile-input" id="address" value="<?php echo e($user->address); ?>">
            ...
            <div class="row" style="padding-top:25px;">
              ...
              <div class="col-md-9">
                <input type="phone-number" style="width:40%;" name="mobile" class="profile-input" id="mobile" value="<?php echo e($user->address); ?>">
            ...
            <div class="row" style="padding-top:25px;">
              ...
              <div class="col-md-9">
                <input type="text" style="width:60%;" name="email" class="profile-input" id="email" value="<?php echo e($user->email); ?>">
              </div>
            </div>
            <div class="row" style="padding-top:25px;">
              <div class="col-md-3 text-right">
              ...
              <div class="col-md-9">
                <input type="text" style="width:40%;" name="created_at" class="profile-input" id="created_at" value="<?php echo e($user->created_at); ?>">
              </div>
            </div>
            <div class="row" style="padding-top:25px;">
              <div class="col-md-3 text-right">
              ...
              <div class="col-md-9">
                <label class="filelink">
                  <img width="30px" height="30px" src="<?php echo e(asset('assets/frontend/layout/img/icons/link.png')); ?>">接続された支払い
                </label>
                <label class="filelink">
                  <img width="30px" height="30px" src="<?php echo e(asset('assets/frontend/layout/img/icons/unlink.png')); ?>">切断された支払い
                </label>
              </div>
            </div>
          </div>
    ...
    <div id="review-part" hidden>>
      <div class="row">
        ...
        <img style="float:left;width:30px; margin-left:100px;" src="<?php echo e(asset('assets/frontend/layout/img/icons/usersearch.png')); ?>" alt="">
        ...
        <div class="col-md-10">
          ...
          <div class="col-md-12">
                ...
                <div class="col-md-5">
                  <div class="row">
                    ...
                    <div class="row" style="float:left;">
                      <a href="javascript:;" class="btn btn-default add2cart" ><img src="<?php echo e(asset('assets/frontend/pages/img/hotspring/star.png')); ?>"  alt=""> </a>
                    </div>
                  </div>
                </div>
                <a href="<?php echo e(URL::to('feedback/Japan Star Hot Spring')); ?>">
                  <img src="<?php echo e(asset('assets/frontend/pages/img/hotspring/s_list2.jpg')); ?>" class="img-responsive" alt="">
                </a>
              </div>
            </div>
            <div class="col-md-4">
            <div class="product-item"> 
                ...
                <a href="<?php echo e(URL::to('feedback/Japan Star Hot Spring')); ?>">
                  <img src="<?php echo e(asset('assets/frontend/pages/img/hotspring/s_list3.jpg')); ?>" class="img-responsive" alt="">
                </a>
                <!-- <div class="pi-img-wrapper" onclick="window.location.href = 'view/2000/review';">
                  <img src="<?php echo e(asset('assets/frontend/pages/img/hotspring/s_list3.jpg')); ?>" class="img-responsive" alt="">
                  <div>
                    <a href="<?php echo e(asset('assets/frontend/pages/img/hotspring/s_list3.jpg')); ?>" class="btn btn-default fancybox-button">Zoom</a>
            ...
            <div class="product-item"> 
                ...
                <a href="<?php echo e(URL::to('hotspring/Japan Star Hot Spring/hotspring_review')); ?>">
                  <img src="<?php echo e(asset('assets/frontend/pages/img/hotspring/s_list4.jpg')); ?>" class="img-responsive" alt="">
                </a>
                <!-- <div class="pi-img-wrapper" onclick="window.location.href = 'view/2000/review';">
                  <img src="<?php echo e(asset('assets/frontend/pages/img/hotspring/s_list4.jpg')); ?>" class="img-responsive" alt="">
                  <div>
                    <a href="<?php echo e(asset('assets/frontend/pages/img/hotspring/s_list4.jpg')); ?>" class="btn btn-default fancybox-button">Zoom</a>
...
function showMainPart(menuName){
    switch(menuName){
        case 'userinfo':
            $('.slide-icon.userinfo').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/userinfo_hover.png')); ?>");
            $('.slide-icon.userinfo_btn').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/userinfo_btn_hover.png')); ?>");
            $('.slide-icon.search').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/usersearch.png')); ?>");
            $('.slide-icon.search_btn').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/usersearch_btn.png')); ?>");
            $('.slide-icon.userfeedback').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/userfeedback.png')); ?>");
            $('.slide-icon.userfeedback_btn').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/userfeedback_btn.png')); ?>");
            $('#mainpart').html( $('#userinfo-part').html());
        break;
        case 'search':
            $('.slide-icon.userinfo').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/userinfo.png')); ?>");
            $('.slide-icon.userinfo_btn').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/userinfo_btn.png')); ?>");
            $('.slide-icon.search').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/usersearch_hover.png')); ?>");
            $('.slide-icon.search_btn').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/usersearch_btn_hover.png')); ?>");
            $('.slide-icon.userfeedback').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/userfeedback.png')); ?>");
            $('.slide-icon.userfeedback_btn').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/userfeedback_btn.png')); ?>");
        ...
        case 'feedback':
            ...
            $('.slide-icon.search').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/usersearch.png')); ?>");
            $('.slide-icon.search_btn').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/usersearch_btn.png')); ?>");
            $('.slide-icon.userfeedback').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/userfeedback_hover.png')); ?>");
            $('.slide-icon.userfeedback_btn').attr('src',"<?php echo e(asset('assets/frontend/layout/img/icons/userfeedback_btn_hover.png')); ?>");
