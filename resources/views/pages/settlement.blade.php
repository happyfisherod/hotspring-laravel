...
<form action="{{ URL::to('send_order') }}" method="get">
 ...
 <tr class=S1>
  <td class=S1>
   ...
   <table cellspacing=4 cellpadding=4 style="text-align:left;">
    ...
    <tr>
     <td>氏名</td>
     <td><input type="text" name="user_name" value="{{$user->first_name}} {{$user->last_name}}"></td>
    </tr>
    <tr>
     <td>メールアドレス</td>
     <td><input type="text" name="user_mail_add" value="{{$user->email}}"></td>
    </tr>
    <tr>
        <td>決済区分</td>
    ...
    <tr>
        <td>ユーザ名(カナ)</td>
        <td><input type="text" name="user_name_kana" value="{{$user->last_name}}"></td>
    </tr>
    <tr>
        <td>ユーザ電話番号</td>
        <td><input type="text" name="user_tel" value="{{$user->mobile}}"></td>
    </tr>
    <tr>
        <td>送り先郵便番号</td>
        <td><input type="text" name="consignee_postal" value="{{$user->address}}"></td>
    </tr>
    <tr>
        <td>送り先住所</td>
