                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-6">                    
                    <div class="col-md-12 margin-bottom-5">
                      &nbsp;&nbsp;1523 &nbsp;&nbsp;<img src="{{asset('assets/frontend/pages/img/hotspring/star.png')}}"  alt=""> 
                    </div>
                  </div>                   
                </div>
              </div>
              <div class="pi-img-wrapper">
                <img src="{{asset('assets/frontend/pages/img/hotspring/hotspring1.jpg')}}" class="img-responsive" alt="">
                <div>
                  <a href="{{asset('assets/frontend/pages/img/hotspring/hotspring1.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>                      
                </div>
              </div>                
            </div>
          </div>
            ...
            <div class="product-item">
              <div class="row">                   
                <div class="col-md-12">
                  ...
                  <div class="col-md-6">                    
                    <div class="col-md-12 margin-bottom-5">
                      &nbsp;&nbsp;1498 &nbsp;&nbsp;<img src="{{asset('assets/frontend/pages/img/hotspring/star.png')}}"  alt=""> 
                    </div>
                  </div>
                </div> 
              </div>
              <div class="pi-img-wrapper">
                <img src="{{asset('assets/frontend/pages/img/hotspring/hotspring2.jpg')}}" class="img-responsive" alt="">
                <div>
                  <a href="{{asset('assets/frontend/pages/img/hotspring/hotspring2.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>                     
                </div>
              </div>              
            </div>
          </div>
          <div>
            ...
            <div class="row">                   
                <div class="col-md-12">
                  ...
                  <div class="col-md-6">                       
                    <div class="col-md-12 margin-bottom-5">
                      &nbsp;&nbsp;1356 &nbsp;&nbsp;<img src="{{asset('assets/frontend/pages/img/hotspring/star.png')}}"  alt=""> 
                    </div>
                  </div>
                </div> 
            </div>
              <div class="pi-img-wrapper">
                <img src="{{asset('assets/frontend/pages/img/hotspring/hotspring3.jpg')}}" class="img-responsive" alt="">
                <div>
                  <a href="{{asset('assets/frontend/pages/img/hotspring/hotspring3.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                </div>
              </div>
            </div>
          </div>
          <div>
              ...
              <div class="row">                   
                <div class="col-md-12">
                  ...
                  <div class="col-md-6">                       
                    <div class="col-md-12 margin-bottom-5">
                      &nbsp;&nbsp;1289 &nbsp;&nbsp;<img src="{{asset('assets/frontend/pages/img/hotspring/star.png')}}"  alt=""> 
                    </div>
                  </div>
                </div> 
            </div>
                <div class="pi-img-wrapper">
                  <img src="{{asset('assets/frontend/pages/img/hotspring/hotspring4.jpg')}}" class="img-responsive" alt="">
                  <div>
                    <a href="{{asset('assets/frontend/pages/img/hotspring/hotspring4.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                  </div>
                </div>       
              </div>
          </div>
          <div>
            ...
            <div class="row">                   
                <div class="col-md-12">
                  ...
                  <div class="col-md-6">                       
                    <div class="col-md-12 margin-bottom-5">
                      &nbsp;&nbsp;1114 &nbsp;&nbsp;<img src="{{asset('assets/frontend/pages/img/hotspring/star.png')}}"  alt=""> 
                    </div>
                  </div>
                </div> 
            </div>
              <div class="pi-img-wrapper">
                <img src="{{asset('assets/frontend/pages/img/hotspring/hotspring5.jpg')}}" class="img-responsive" alt="">
                <div>
                  <a href="{{asset('assets/frontend/pages/img/hotspring/hotspring5.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
          ...
          <div>
            ...
            <div class="row">                   
                <div class="col-md-12">
                  ...
                  <div class="col-md-6">                       
                    <div class="col-md-12 margin-bottom-5">
                      &nbsp;&nbsp;1019 &nbsp;&nbsp;<img src="{{asset('assets/frontend/pages/img/hotspring/star.png')}}"  alt=""> 
                    </div>
                  </div>
                </div> 
            </div>
              <div class="pi-img-wrapper">
                <img src="{{asset('assets/frontend/pages/img/hotspring/hotspring6.jpg')}}" class="img-responsive" alt="">
                <div>
                  <a href="{{asset('assets/frontend/pages/img/hotspring/hotspring6.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>                     
                </div>
              </div>
            </div>
          </div>
          <div>
            ...
            <div class="row">                   
                <div class="col-md-12">
                  ...
                  <div class="col-md-6">                       
                    <div class="col-md-12 margin-bottom-5">
                      &nbsp;&nbsp;998 &nbsp;&nbsp;<img src="{{asset('assets/frontend/pages/img/hotspring/star.png')}}"  alt=""> 
                    </div>
                  </div>
                </div> 
            </div>
              <div class="pi-img-wrapper">
                <img src="{{asset('assets/frontend/pages/img/hotspring/hotspring7.jpg')}}" class="img-responsive" alt="">
                <div>
                  <a href="{{asset('assets/frontend/pages/img/hotspring/hotspring7.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>                      
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-10">
                <div class="col-md-6">
                    ...
                    <div class="row margin-bottom-20 div-hr">
                      ...
                      <div class="row col-md-10">                         
                          <div class="col-md-4">                               
                            <img src="{{asset('assets/frontend/pages/img/hotspring/blog1.jpg')}}" class="blog_img"> 
                          </div>
                    ...
                    <div class="row margin-bottom-20 div-hr">
                      ...
                      <div class="row col-md-10">                         
                          <div class="col-md-4">                              
                            <img src="{{asset('assets/frontend/pages/img/hotspring/blog2.jpg')}}" class="blog_img"> 
                          </div>
                          <div class="col-md-4 blog_content">
                            記事の内容<br>
                            記事の内容<br>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row margin-bottom-20 div-hr">
                          ...
                          <div class="row col-md-10">                         
                              <div class="col-md-4">
                                <img src="{{asset('assets/frontend/pages/img/hotspring/blog1.jpg')}}" class="blog_img_sm"> 
                              </div>
                    ...
                    <div class="row margin-bottom-20 div-hr">
                          ...
                          <div class="row col-md-10">                         
                              <div class="col-md-4">                                 
                                <img src="{{asset('assets/frontend/pages/img/hotspring/blog2.jpg')}}" class="blog_img_sm"> 
                              </div>
                              <div class="col-md-5 blog_content_sm">
                              2020年4月20日<br>
                              シンプルなコンテンツ<br>                              
                    ...
                    <div class="row margin-bottom-20 div-hr">
                          ...
                          <div class="row col-md-10">                         
                              <div class="col-md-4">                                   
                                <img src="{{asset('assets/frontend/pages/img/hotspring/blog3.jpg')}}" class="blog_img_sm"> 
                              </div>
                              <div class="col-md-5 blog_content_sm">
                              2020年4月20日<br>
                              シンプルなコンテンツ<br>                              
          ...
          <div class="bx-wrapper" style="max-width: 1390px;">
              <div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 255px;">
                  <ul id="slidbnr_pc" style="width: 1215%; position: relative; left: -3071.37px;">  
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;"><img src="{{asset('assets/frontend/layout/img/s1.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;"><img src="{{asset('assets/frontend/layout/img/s2.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;"><img src="{{asset('assets/frontend/layout/img/s3.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;"><img src="{{asset('assets/frontend/layout/img/s4.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;"><img src="{{asset('assets/frontend/layout/img/s5.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;"><img src="{{asset('assets/frontend/layout/img/s6.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;"><img src="{{asset('assets/frontend/layout/img/s7.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;"><img src="{{asset('assets/frontend/layout/img/s8.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;"><img src="{{asset('assets/frontend/layout/img/s9.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;"><img src="{{asset('assets/frontend/layout/img/s10.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;" class="bx-clone"><img src="{{asset('assets/frontend/layout/img/s1.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;" class="bx-clone"><img src="{{asset('assets/frontend/layout/img/s2.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;" class="bx-clone"><img src="{{asset('assets/frontend/layout/img/s3.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;" class="bx-clone"><img src="{{asset('assets/frontend/layout/img/s4.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;" class="bx-clone"><img src="{{asset('assets/frontend/layout/img/s5.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;" class="bx-clone"><img src="{{asset('assets/frontend/layout/img/s6.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;" class="bx-clone"><img src="{{asset('assets/frontend/layout/img/s7.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;" class="bx-clone"><img src="{{asset('assets/frontend/layout/img/s8.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;" class="bx-clone"><img src="{{asset('assets/frontend/layout/img/s9.jpg')}}"></li>
                    <li style="float: left; list-style: none; position: relative; width: 340px; margin-right: 10px;" class="bx-clone"><img src="{{asset('assets/frontend/layout/img/s10.jpg')}}"></li>
                  </ul>
              </div>
            </div>
      </div>
    ...
    <div class="row" style="display:flex; margin:30px 10px;">
      <div class="col-md-3">
        <div style="max-width:400px; max-height: 800px;">
          <img src="{{ URL::asset('upload/menu/'.$menu->image.'-s.jpg') }}" class="img-responsive" alt="">
        </div>
      </div>
      ...
      <div class="col-md-5">
          <p class="new-part-name"> {{ $menu->name }} </p>
          <p class="new-part-content"> 大人料金 : {{ $menu->grownprice }} 円</p>
          <p class="new-part-content"> 小人 : {{ $menu->childprice }} 円</p>
          <p class="new-part-content"> 営業時間 : {{ $menu->openhour }} ~ {{ $menu->closehour }} </p>
          <p class="new-part-content"> ホームページ : {{ $menu->urlname }} </p>
          <p class="new-part-content"> 電話番号 :  {{ $menu->phonenumber }} </p>
          <p class="new-part-content"> 住所 :  {{ $menu->streetaddress }} </p>
          <p class="new-part-content"> 都道府県 : {{ $menu->season }} </p>
          <p class="new-part-content"> 市町村 : {{ $menu->municipality }} </p>                                   
      </div>
      <div class="col-md-4">
        <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><a class="new-part-button" style="float: left; " href="{{ $menu->urlname }}" target="_blank">サイトに行く</a>
      </div>
    </div>
  @endforeach
</div>
        ...
        <div class="product-item">
          <div class="row">                   
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-6">
                  <a style="font-size:20px;color:black;" href="">{{ $menu->name }}</a>
                </div>
                <div class="col-md-6">
                  <div class="row">
                    <div style="font-size:20px;color:black;">{{ $menu->hotspring_id }}</div>
                  </div>                  
                  <div class="row"><img src="{{asset('assets/frontend/pages/img/hotspring/star.png')}}" alt=""> </div>
                </div> 
              </div>         
            </div>
          </div>               
          <div class="row">
            <div class="pi-img-wrapper">
              <div>
                <a href="javascript:;"><img src="{{ URL::asset('upload/menu/'.$menu->image.'-s.jpg') }}" class="img-responsive" alt="">
              </div>
              <div>
              <a href="{{ URL::asset('upload/menu/'.$menu->image.'-s.jpg') }}" class="btn btn-default fancybox-button">Zoom</a>
              </div>
            </div>  
          </div>          
        </div> 
