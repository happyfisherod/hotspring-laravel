...
@section("content")
 ...
 <div class="sub-banner" style="background:url({{ URL::asset('upload/'.getcong('page_bg_image')) }}) no-repeat center top;">
    <div class="overlay">
      <div class="container">
        <h1>{{ trans('messages.Contact Us') }}</h1>
      </div>
    </div>
  </div>
    ...
    <div class="contact-form">
      <div class="col-sm-6">                
        ...
        @endif      
          ...
          <ul class="row">
            <li class="col-sm-6">
              <label class="font-montserrat">{{ trans('messages.Your Name') }} <span class="required">*</span>
                <input type="text" class="form-control" name="name" id="name" placeholder="">
              </label>
            </li>
            <li class="col-sm-6">
              <label class="font-montserrat">{{ trans('messages.Your Email') }} <span class="required">*</span>
                <input type="text" class="form-control" name="email" id="email" placeholder="">
              </label>
            </li>
            <li class="col-sm-6">
              <label class="font-montserrat">{{ trans('messages.Phone') }} 
                <input type="text" class="form-control" name="phone" id="phone" placeholder="">
              </label>
            </li>
            <li class="col-sm-6">
              <label class="font-montserrat">{{ trans('messages.Subject') }}
                <input type="text" class="form-control" name="subject" id="subject" placeholder="">
              </label>
            </li>
            <li class="col-sm-12">
              <label class="font-montserrat">{{ trans('messages.Message') }}
                <textarea class="form-control" name="message" id="message" rows="5" placeholder=""></textarea>
              </label>
            </li>
            
            <li class="col-sm-8">
              <button type="submit" value="submit" class="btn font-montserrat" id="btn_submit" onClick="proceed();">{{ trans('messages.Submit') }}</button>
            </li>
          </ul>
        {!! Form::close() !!}
      </div>
    <div class="col-sm-6">
      <h5>{{ trans('messages.Contact Info') }}</h5>          
          <div class="loc-info">
