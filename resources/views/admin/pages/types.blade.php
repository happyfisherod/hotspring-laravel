...
<div id="main">
	<div class="page-header">
		...
		<div class="pull-right">
			<a href="{{URL::to('admin/types/addtype')}}" class="btn btn-primary">{{ trans('messages.Add Type')}} <i class="fa fa-plus"></i></a>
		</div>
		<h2>{{ trans('messages.Restaurant Types')}}</h2>
	</div>
