...
<div id="main">
	<div class="page-header">
		...
		<a href="{{ URL::to('admin/restaurants/view/'.$hotspring_id.'/menu') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> Back</a>
	...
	@endif
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open(array('url' => array('admin/restaurants/view/'.$hotspring_id.'/menu/addmenu'),'class'=>'form-horizontal padding-15','name'=>'menu_form','id'=>'menu_form','role'=>'form','enctype' => 'multipart/form-data')) !!} 
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Recommended Dish ?</label>
                      <div class="col-sm-9">
                         
                        <input id="touch-spin-2"   type="checkbox" value="{{ isset($menu->recommended) ? $menu->recommended : null }}" name="recommended" class="form-control"/>
                    </div>
                </div>
