...
<div id="main">
	<div class="page-header">
		...
		<div class="pull-right">
			<a href="{{URL::to('admin/restaurants/addrestaurant')}}" class="btn btn-primary">{{ trans('messages.Add HotSpring')}} <i class="fa fa-plus"></i></a>
		</div>
		<h2>{{ trans('messages.HotSpring')}}</h2>
	</div>
    ...
    <div class="panel-body">
        ...
        <table id="data-table" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <th>{{ trans('messages.HotSpring Categories')}}</th>
                <th>{{ trans('messages.HotSpring Items')}}</th>
