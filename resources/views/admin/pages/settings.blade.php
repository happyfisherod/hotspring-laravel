        ...
        <div role="tabpanel" class="tab-pane active" id="account">             
            {!! Form::open(array('url' => 'admin/settings','class'=>'form-horizontal padding-15','name'=>'account_form','id'=>'account_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="phone" value="{{ $settings->phone }}" class="form-control" placeholder="Phone Number">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Delivery Fee</label>
                    <div class="col-sm-9">
                        <input type="text" name="delifee" value="{{ $settings->delifee }}" class="form-control" placeholder="Delivery Fee">
                    </div>
                </div>
                <div class="form-group">
