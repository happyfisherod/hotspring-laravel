...
<span aria-hidden="true">&times;</span></button>
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation">
            <a href="#about_widget" aria-controls="about_widget" role="tab" data-toggle="tab">{{ trans('messages.About Us Page')}}</a>
        </li>        
        <li role="presentation">
            <a href="#followus" aria-controls="followus" role="tab" data-toggle="tab">{{ trans('messages.Social Links')}}</a>
        </li>
        <li role="presentation">
            <a href="#need_help" aria-controls="need_help" role="tab" data-toggle="tab">{{ trans('messages.Need Help?')}}</a>
        </li>               
        ...
        <div role="tabpanel" class="tab-pane active" id="footer_widgets">             
            {!! Form::open(array('url' => 'admin/footer_widgets','class'=>'form-horizontal padding-15','name'=>'about_contact_widgets_form','id'=>'about_contact_widgets_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 1 {{ trans('messages.Title')}}</label>
                    <div class="col-sm-9">
                        <input type="text" name="footer_widget1_title" value="{{ $widgets->footer_widget1_title }}" class="form-control" value="">
                    </div>
                </div>                
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 1 {{ trans('messages.Description')}}</label>
                    <div class="col-sm-9">
                ...
                <hr>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 2 {{ trans('messages.Title')}}</label>
                    <div class="col-sm-9">
                        <input type="text" name="footer_widget2_title" value="{{ $widgets->footer_widget2_title }}" class="form-control" value="">
                    </div>
                </div>                
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 2 {{ trans('messages.Description')}}</label>
                    <div class="col-sm-9">
                ...
                <hr>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 3 {{ trans('messages.Title')}}</label>
                    <div class="col-sm-9">
                        <input type="text" name="footer_widget3_title" value="{{ $widgets->footer_widget2_title }}" class="form-control" value="">
                    </div>
                </div>                
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 3 {{ trans('messages.Address')}}</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 3 {{ trans('messages.Phone')}}</label>
                    <div class="col-sm-9">
                        <input type="text" name="footer_widget3_phone" value="{{ $widgets->footer_widget3_phone }}" class="form-control" value="">
                    </div>
                </div>  
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 3 {{ trans('messages.Email')}}</label>
                    <div class="col-sm-9">
