...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('settings')->insert([            
            ...
            'site_description' => ' Food Delivery Script  - Food Delivery is an laravel script for Delivery Restaurants',
            'site_copyright' => 'Copyright © 2016  - Food Delivery Script. All Rights Reserved.',
		...
		DB::table('hotspring_types')->insert([
			'type' => 'American',
